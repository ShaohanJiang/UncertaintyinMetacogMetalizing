%% DMPFC IN OC replacement
clear; home;
load('../BehavNeuralTbl.mat', 'BehavNeuraltbl_OC')
st = tic;
thistbl = BehavNeuraltbl_OC;
nsub = height(thistbl);
maxlen = 10;
ntimes = 1e4;
...
toc(st)
%
save res_dmpfcinoc_simulation_replacement_10k after* before* maxlen
...
xlim([0.5,10.5])
ylim([0.46, 0.54])
set(gca, 'XTick', 1:10, 'YTick',0.46:0.02:0.54, 'LineWidth',1);
hold on
plot([0.5, 10.5], [0.5, 0.5], 'k--')
set(gca, 'XTickLabel',{}, 'YTickLabel',{});

%% paint confidence correlation before and after shuffle
...
xlim([1.5,10.5])
ylim([-0.1, 0.2])
set(gca, 'XTick', 1:10, 'YTick',-0.1:0.1:0.2, 'LineWidth',1);
hold on
plot([0.5,10.5], [0,0], 'k--')
